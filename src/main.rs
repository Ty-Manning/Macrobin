...
use crate::args::ARGS;
use crate::endpoints::{
    admin, auth_admin, auth_upload, api, create, edit, errors, file, guide, list,
...
pub mod args;
pub mod pasta;
pub mod endpoints; // This will load src/endpoints/mod.rs
...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .service(api::create_api) // New API endpoint
